...
env1_peakbf2 <- read_csv("Genomics_scripts/Data/win_bf_mat.csv")
env2_peakbf2 <- read_csv("Genomics_scripts/Data/win_bf_map.csv")
env5_peakbf2 <- read_csv("Genomics_scripts/Data/win_bf_cmd.csv")
...
write_csv(snp_clim_bay, "Genomics_scripts/Data/snp_clim_peakbf2.csv")

#Remove NA's
snp_clim_bf2NA <- snp_clim_bay %>% select_if(~ !any(is.na(.)))
write_csv(snp_clim_bf2NA, "Genomics_scripts/Data/snp_clim_peakbf2.csv")
