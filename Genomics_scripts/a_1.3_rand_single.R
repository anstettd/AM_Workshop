...
write_csv(rand_gathered_MAT, "Genomics_scripts/Data/rand_gathered_mat_peakbf2.csv")
write_csv(rand_gathered_MAP, "Genomics_scripts/Data/rand_gathered_map_peakbf2.csv")
write_csv(rand_gathered_CMD, "Genomics_scripts/Data/rand_gathered_cmd_peakbf2.csv")
