...
slope_mat_bf0_p1 <- slope_mat %>% filter(Site==1) %>% filter(BF>0)
slope_mat2_bf0_p1 <- slope_mat2 %>% filter(Site==1) %>% filter(BF>0)

slope_mat_bf10_p1 <- slope_mat %>% filter(Site==1) %>% filter(BF>10)
slope_mat2_bf10_p1 <- slope_mat2 %>% filter(Site==1) %>% filter(BF>10)
...
slope_bf2 <- ggplot(slope_mat2_bf10_p1, aes(x=Slope, y=BF)) + 
  geom_hex() +
  #geom_bin2d()
  #geom_density_2d()+
...
#+
#  facet_wrap(~Site)
ggsave("/Users/daniel_anstett/Dropbox/AM_Workshop/large_graphs/mat_density_2_bf10_p1.png",
       plot=slope_bf2, width=8, height = 6, units = "in")

#BF > 0

slope_bf2 <- ggplot(slope_mat2_bf0_p1, aes(x=Slope, y=BF)) + 
  geom_hex() +
  #geom_bin2d()
  #geom_density_2d()+
  #stat_density_2d(aes(fill = ..level..), geom = "polygon")+
...
#+
#  facet_wrap(~Site)
ggsave("/Users/daniel_anstett/Dropbox/AM_Workshop/large_graphs/mat_density_2_bf0_p1.png",
       plot=slope_bf2, width=8, height = 6, units = "in")
...
slope_bf2 <- ggplot(slope_mat2_p1, aes(x=Slope, y=BF)) + 
  geom_hex() +
  #geom_bin2d()
  #geom_density_2d()+
  #stat_density_2d(aes(fill = ..level..), geom = "polygon")+
...
#+
#  facet_wrap(~Site)
ggsave("/Users/daniel_anstett/Dropbox/AM_Workshop/large_graphs/mat_density_2_p1.png",
       plot=slope_bf2, width=8, height = 6, units = "in")
...
slope_bf <- ggplot(slope_mat_p1, aes(x=Slope, y=BF)) + 
...
ggsave("/Users/daniel_anstett/Dropbox/AM_Workshop/large_graphs/mat_density_50_p1.png",
...
ggsave("/Users/daniel_anstett/Dropbox/AM_Workshop/large_graphs/mat_density_25_p1.png",
...
ggsave("/Users/daniel_anstett/Dropbox/AM_Workshop/large_graphs/mat_density_5_p1.png",
