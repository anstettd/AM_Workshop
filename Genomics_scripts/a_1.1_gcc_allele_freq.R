...
###################################################################################
#Import peak snp Baseline data bf>10, in order to get basetime frequencies
...
write_csv(freq_MAT_T, "Genomics_scripts/Data/freq_MAT_peakbf2.csv")
write_csv(freq_MAP_T, "Genomics_scripts/Data/freq_MAP_peakbf2.csv")
write_csv(freq_CMD_T, "Genomics_scripts/Data/freq_CMD_peakbf2.csv")
