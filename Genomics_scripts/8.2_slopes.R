##################################################################################
## Get SNP slopes over the timeseries for 2010 to 2014
...
freq_MAT <- read_csv("Genomics_scripts/Data/freq_MAT_region1014.csv")
freq_MAP <- read_csv("Genomics_scripts/Data/freq_MAP_region1014.csv")
freq_CMD <- read_csv("Genomics_scripts/Data/freq_CMD_region1014.csv")

###################################################################################
###################################################################################
#Test case for single glm
test_fMat <- freq_MAT %>% filter(Site=="North") %>% select(Site,Year,CE10_chr1_865732,CE10_chr1_1521089)
...
write_csv(freq_MAT_slope, "Genomics_scripts/Data/freq_MAT_slope_region1014.csv")
write_csv(freq_MAP_slope, "Genomics_scripts/Data/freq_MAP_slope_region1014.csv")
write_csv(freq_CMD_slope, "Genomics_scripts/Data/freq_CMD_slope_region1014.csv")
