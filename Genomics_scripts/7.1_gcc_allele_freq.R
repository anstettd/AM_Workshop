...
write_csv(freq_MAT_T, "Genomics_scripts/Data/freq_MAT_region.csv")
write_csv(freq_MAP_T, "Genomics_scripts/Data/freq_MAP_region.csv")
write_csv(freq_CMD_T, "Genomics_scripts/Data/freq_CMD_region.csv")
