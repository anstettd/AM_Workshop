...
MAT_hist <- MAT_hist + facet_wrap(.~Site)
MAT_hist
ggsave("Slope_graphs/MAT_site.pdf",width=11, height = 7, units = "in")
...
MAP_hist <- MAP_hist + facet_wrap(.~Site)
MAP_hist
ggsave("Slope_graphs/MAP_site.pdf",width=11, height = 7, units = "in")
...
CMD_hist <- CMD_hist + facet_wrap(.~Site)
CMD_hist
ggsave("Slope_graphs/CMD_site.pdf",width=11, height = 7, units = "in")
...
MAT_hist <- MAT_hist  + theme(
  ...
  xlim(-2,2)
  MAT_hist
ggsave("Slope_graphs/limited/MAT_all_lim.pdf",width=11, height = 7, units = "in")
...
#MAP_hist <- MAP_hist + facet_wrap(.~Site)
  xlim(-2,2)
MAP_hist
ggsave("Slope_graphs/limited/MAP_all_lim.pdf",width=11, height = 7, units = "in")
...
#CMD_hist <- CMD_hist + facet_wrap(.~Site)
  xlim(-2,2)
CMD_hist
ggsave("Slope_graphs/limited/CMD_all_lim.pdf",width=11, height = 7, units = "in")
...
MAT_hist <- MAT_hist + facet_wrap(.~Site)
MAT_hist
ggsave("Slope_graphs/limited/MAT_site_lim.pdf",width=11, height = 7, units = "in")
...
MAP_hist <- MAP_hist + facet_wrap(.~Site)
MAP_hist
ggsave("Slope_graphs/limited/MAP_site_lim.pdf",width=11, height = 7, units = "in")
...
CMD_hist <- CMD_hist + facet_wrap(.~Site)
CMD_hist
ggsave("Slope_graphs/limited/CMD_site_lim.pdf",width=11, height = 7, units = "in")
