...
win_bf_mat  <- read_csv("Genomics_scripts/Data/win_bf_mat30_5.csv")
win_bf_map  <- read_csv("Genomics_scripts/Data/win_bf_map30_5.csv")
win_bf_cmd  <- read_csv("Genomics_scripts/Data/win_bf_cmd30_5.csv")
...
write_csv(peak_bf2_time_mat,"Genomics_scripts/Data/peak_bf5_time_mat.csv")
write_csv(peak_bf2_time_map,"Genomics_scripts/Data/peak_bf5_time_map.csv")
write_csv(peak_bf2_time_cmd,"Genomics_scripts/Data/peak_bf5_time_cmd.csv")

write_csv(peak_bf2_base_mat,"Genomics_scripts/Data/peak_bf5_base_mat.csv")
write_csv(peak_bf2_base_map,"Genomics_scripts/Data/peak_bf5_base_map.csv")
write_csv(peak_bf2_base_cmd,"Genomics_scripts/Data/peak_bf5_base_cmd.csv")
