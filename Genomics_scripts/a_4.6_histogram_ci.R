...
#Import files
mat_obs_ci <- read_csv("mat_obs_ci_peakbf2.csv")
map_obs_ci <- read_csv("map_obs_ci_peakbf2.csv")
cmd_obs_ci <- read_csv("cmd_obs_ci_peakbf2.csv")
env_obs_ci <- read_csv("env_obs_ci_peakbf2.csv")
...
mat_p1_hist 
ggsave("Graphs_CI_peak_pop/1_01env_hist_ci_p1.pdf",width=10, height = 6, units = "in")
...
mat_p12_hist 
ggsave("Graphs_CI_peak_pop/1_02env_hist_ci_p12.pdf",width=10, height = 6, units = "in")
...
mat_p2_hist 
ggsave("Graphs_CI_peak_pop/1_03env_hist_ci_p2.pdf",width=10, height = 6, units = "in")
...
mat_p3_hist 
ggsave("Graphs_CI_peak_pop/1_04env_hist_ci_p3.pdf",width=10, height = 6, units = "in")
...
mat_p4_hist 
ggsave("Graphs_CI_peak_pop/1_05env_hist_ci_p4.pdf",width=10, height = 6, units = "in")
...
mat_p5_hist 
ggsave("Graphs_CI_peak_pop/1_06env_hist_ci_p5.pdf",width=10, height = 6, units = "in")
...
mat_p6_hist 
ggsave("Graphs_CI_peak_pop/1_07env_hist_ci_p6.pdf",width=10, height = 6, units = "in")
...
mat_p7_hist 
ggsave("Graphs_CI_peak_pop/1_08env_hist_ci_p7.pdf",width=10, height = 6, units = "in")
...
mat_p8_hist 
ggsave("Graphs_CI_peak_pop/1_09env_hist_ci_p8.pdf",width=10, height = 6, units = "in")
...
mat_p9_hist 
ggsave("Graphs_CI_peak_pop/1_10env_hist_ci_p9.pdf",width=10, height = 6, units = "in")
...
mat_p10_hist 
ggsave("Graphs_CI_peak_pop/1_11env_hist_ci_p10.pdf",width=10, height = 6, units = "in")
...
mat_p11_hist 
ggsave("Graphs_CI_peak_pop/1_12env_hist_ci_p11.pdf",width=10, height = 6, units = "in")
