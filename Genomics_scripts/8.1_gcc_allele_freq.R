##################################################################################
## Generate SNP proportion matrix per region for 2010 to 2014
...
#Pool timeseries populations into regions
...
write_csv(freq_MAT_T, "Genomics_scripts/Data/freq_MAT_region1014.csv")
write_csv(freq_MAP_T, "Genomics_scripts/Data/freq_MAP_region1014.csv")
write_csv(freq_CMD_T, "Genomics_scripts/Data/freq_CMD_region1014.csv")
