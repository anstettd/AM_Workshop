...
peak_bf2_time_mat <-loci_snp %>% filter (chr_snp %in% as.character(win_bf_mat$chr_snp))
peak_bf2_time_map <-loci_snp %>% filter (chr_snp %in% as.character(win_bf_map$chr_snp))
peak_bf2_time_cmd <-loci_snp %>% filter (chr_snp %in% as.character(win_bf_cmd$chr_snp))


#Filter baseline by peak window, BF>2 SNP IDs
peak_bf2_base_mat <-loci_snp %>% filter (chr_snp %in% as.character(win_bf_mat$chr_snp))
peak_bf2_base_map <-loci_snp %>% filter (chr_snp %in% as.character(win_bf_map$chr_snp))
peak_bf2_base_cmd <-loci_snp %>% filter (chr_snp %in% as.character(win_bf_cmd$chr_snp))
