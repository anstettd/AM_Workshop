...
write_csv(rand_slope_mat_out, "rand_slope_mat_multi_peakbf2.csv")
write_csv(rand_slope_map_out, "rand_slope_map_multi_peakbf2.csv")
write_csv(rand_slope_cmd_out, "rand_slope_cmd_multi_peakbf2.csv")
