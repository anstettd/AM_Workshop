...
write_csv(freq_MAT_slope, "Genomics_scripts/Data/freq_MAT_slope_region.csv")
write_csv(freq_MAP_slope, "Genomics_scripts/Data/freq_MAP_slope_region.csv")
write_csv(freq_CMD_slope, "Genomics_scripts/Data/freq_CMD_slope_region.csv")
